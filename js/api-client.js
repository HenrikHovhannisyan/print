    ...
    async function saveDesign(params) {
        return request('/designs', {
            ...
            body: JSON.stringify({
                ...
                canvas_json_back: params.canvasJsonBack,
                svg_data: params.svgData,
                svg_data_back: params.svgDataBack,
                highres_data: params.highresDataUrl,
                highres_data_back: params.highresDataUrlBack,
                preview_data: params.previewDataUrl,
                preview_data_back: params.previewDataUrlBack,
                is_double_sided: params.isDoubleSided ? 1 : 0,
